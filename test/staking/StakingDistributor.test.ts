...
describe("Distributor", () => {
    ...
    describe("constructor", () => {
      it("constructs correctly", async () => {
            let distributor = await (new Distributor__factory(owner)).deploy(
    ...
    describe("post-construction", () => {
      ...
      describe("distribute", () => {
        ...
        it("can only be called by the staking contract", async () => {
          await expect(distributor.connect(governor).distribute()).
            to.be.revertedWith("Only staking");

          await expect(distributor.connect(guardian).distribute()).
            to.be.revertedWith("Only staking");

          await expect(distributor.connect(owner).distribute()).
            to.be.revertedWith("Only staking");
        });
