...
describe('SushiMigrator', async () => {
    ...
    beforeEach(async () => {
        ...
        treasury = await ethers.getContractAt("OlympusTreasury", '0x9A315BdF513367C0377FB36545857d12e85813Ef');
        ohmContract = await ethers.getContractAt("contracts/interfaces/IERC20.sol:IERC20", '0x64aa3364F17a4D01c6f1751Fd97C2BD3D7e7f1D5');
    ...
    it('Migrate Sushi OHM/DAI pair to Uniswap OHM/DAI pair', async () => {   
        ...
        const uniswapLpContract = await ethers.getContractAt("contracts/interfaces/IERC20.sol:IERC20", uniOhmDaiLpAddress);
        const daiContract = await ethers.getContractAt("contracts/interfaces/IERC20.sol:IERC20", '0x6B175474E89094C44Da98b954EedeAC495271d0F');

        await treasury.connect(governor).enable(
            3,
        ...
        await sushiMigrator.connect(governor).executeTx(
            sushiRouter,
            uniRouter,
    ...
    it('Migrate Sushi OHM/ETH pair to Uniswap OHM/ETH pair', async () => {  
        ...
        const uniswapLpContract = await ethers.getContractAt("contracts/interfaces/IERC20.sol:IERC20", uniOhmEthLpAddress);
        const wethContract = await ethers.getContractAt("contracts/interfaces/IERC20.sol:IERC20", '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2');
        ...
        await wethContract.connect(user1).transfer('0xa94A3Cd8326EA720f5dE5718C5519f409aFdb9c2','5000000000000000000')
        ...
        await router.connect(user).swapExactTokensForTokens(
            '124735',
            0,
            ['0x64aa3364F17a4D01c6f1751Fd97C2BD3D7e7f1D5','0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2'],
            user.address,
            '1000000000000000000')
