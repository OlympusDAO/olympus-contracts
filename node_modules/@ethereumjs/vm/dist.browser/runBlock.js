...
function encodeReceipt(tx, receipt) {
    ...
    var type = ethereumjs_util_1.intToBuffer(tx.type);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    receiptLog = "Generate tx receipt transactionType=" + tx.type + " gasUsed=" + blockGasUsed.toString() + " bitvector=" + opcodes_1.short(abstractTxReceipt.bitvector) + " (" + abstractTxReceipt.bitvector.length + " bytes) logs=" + abstractTxReceipt.logs.length;
