                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            _b.label = 4;
                        case 4:
                            gasLimit = util_1.maxCallGas(currentGasLimit, runState.eei.getGasLeft(), runState, common);
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            util_1.subMemUsage(runState, outOffset, outLength, common);
                            EIP2929_1.accessAddressEIP2929(runState, toAddress, common);
                            gasLimit = util_1.maxCallGas(currentGasLimit, runState.eei.getGasLeft(), runState, common) // we set TangerineWhistle or later to true here, as STATICCALL was available from Byzantium (which is after TangerineWhistle)
                            ;
                            data = Buffer.alloc(0);
                            if (!inLength.isZero()) {
                                data = runState.memory.read(inOffset.toNumber(), inLength.toNumber());
