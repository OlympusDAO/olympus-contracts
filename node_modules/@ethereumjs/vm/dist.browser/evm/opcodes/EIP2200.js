...
function updateSstoreGasEIP2200(runState, currentStorage, originalStorage, value, key, common) {
    ...
    if (currentStorage.equals(value)) {
        ...
        return runState.eei.useGas(new ethereumjs_util_1.BN(EIP2929_1.adjustSstoreGasEIP2929(runState, key, sstoreNoopCost, 'noop', common)), 'EIP-2200 -> sstoreNoopGasEIP2200');
    }
    ...
    if (originalStorage.equals(value)) {
        if (originalStorage.length === 0) {
            ...
            runState.eei.refundGas(new ethereumjs_util_1.BN(EIP2929_1.adjustSstoreGasEIP2929(runState, key, sstoreInitRefund, 'initRefund', common)), 'EIP-2200 -> initRefund');
        }
        else {
            // Reset to original existing slot
            var sstoreCleanRefund = common.param('gasPrices', 'sstoreCleanRefundEIP2200');
            runState.eei.refundGas(new ethereumjs_util_1.BN(EIP2929_1.adjustSstoreGasEIP2929(runState, key, sstoreCleanRefund, 'cleanRefund', common)), 'EIP-2200 -> cleanRefund');
        }
    }
    // Dirty update
