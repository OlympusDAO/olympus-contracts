...
exports.handlers = new Map([
    ...
    [
        ...
        function (runState, common) {
            ...
            util_1.subMemUsage(runState, offset, length, common);
            let data = Buffer.alloc(0);
            if (!length.isZero()) {
                data = runState.memory.read(offset.toNumber(), length.toNumber());
            }
            // copy fee
            runState.eei.useGas(new ethereumjs_util_1.BN(common.param('gasPrices', 'sha3Word')).imul(util_1.divCeil(length, new ethereumjs_util_1.BN(32))), 'SHA3 opcode');
    ...
    [
        ...
        async function (runState, common) {
            ...
            EIP2929_1.accessAddressEIP2929(runState, address, common);
    ...
    [
        ...
        function (runState, common) {
            ...
            util_1.subMemUsage(runState, memOffset, dataLength, common);
            if (!dataLength.eqn(0)) {
                runState.eei.useGas(new ethereumjs_util_1.BN(common.param('gasPrices', 'copy')).imul(util_1.divCeil(dataLength, new ethereumjs_util_1.BN(32))), 'CALLDATACOPY opcode');
    ...
    [
        ...
        function (runState, common) {
            ...
            util_1.subMemUsage(runState, memOffset, dataLength, common);
            if (!dataLength.eqn(0)) {
                runState.eei.useGas(new ethereumjs_util_1.BN(common.param('gasPrices', 'copy')).imul(util_1.divCeil(dataLength, new ethereumjs_util_1.BN(32))), 'CODECOPY opcode');
    ...
    [
        ...
        async function (runState, common) {
            ...
            if (!dataLength.eqn(0)) {
                // copy fee
                runState.eei.useGas(new ethereumjs_util_1.BN(common.param('gasPrices', 'copy')).imul(util_1.divCeil(dataLength, new ethereumjs_util_1.BN(32))), 'EXTCODECOPY opcode');
    ...
    [
        ...
        function (runState, common) {
            ...
            util_1.subMemUsage(runState, memOffset, dataLength, common);
            if (!dataLength.eqn(0)) {
                runState.eei.useGas(new ethereumjs_util_1.BN(common.param('gasPrices', 'copy')).mul(util_1.divCeil(dataLength, new ethereumjs_util_1.BN(32))), 'RETURNDATACOPY opcode');
    ...
    [
        ...
        function (runState, common) {
            const pos = runState.stack.pop();
            util_1.subMemUsage(runState, pos, new ethereumjs_util_1.BN(32), common);
    ...
    [
        ...
        function (runState, common) {
            ...
            util_1.subMemUsage(runState, offset, new ethereumjs_util_1.BN(32), common);
    ...
    [
        ...
        function (runState, common) {
            ...
            util_1.subMemUsage(runState, offset, new ethereumjs_util_1.BN(1), common);
            const offsetNum = offset.toNumber();
    ...
    [
        ...
        async function (runState, common) {
            ...
            EIP2929_1.accessStorageEIP2929(runState, keyBuf, false, common);
    ...
    [
        ...
        async function (runState, common) {
            ...
            const currentStorage = util_1.setLengthLeftStorage(await runState.eei.storageLoad(keyBuf));
            if (common.hardfork() === 'constantinople' || common.gteHardfork('istanbul')) {
                const originalStorage = util_1.setLengthLeftStorage(await runState.eei.storageLoad(keyBuf, true));
                if (common.hardfork() === 'constantinople') {
                    EIP1283_1.updateSstoreGasEIP1283(runState, currentStorage, originalStorage, util_1.setLengthLeftStorage(value), common);
                }
                else {
                    EIP2200_1.updateSstoreGasEIP2200(runState, currentStorage, originalStorage, util_1.setLengthLeftStorage(value), keyBuf, common);
                }
            }
            else {
                util_1.updateSstoreGas(runState, currentStorage, util_1.setLengthLeftStorage(value), keyBuf, common);
            }
            ...
            EIP2929_1.accessStorageEIP2929(runState, keyBuf, true, common);
    ...
    [
        ...
        function (runState, common) {
            ...
            util_1.subMemUsage(runState, memOffset, memLength, common);
    ...
    [
        ...
        async function (runState, common) {
            ...
            EIP2929_1.accessAddressEIP2929(runState, runState.eei.getAddress(), common, false);
            util_1.subMemUsage(runState, offset, length, common);
            let gasLimit = new ethereumjs_util_1.BN(runState.eei.getGasLeft());
            gasLimit = util_1.maxCallGas(gasLimit, runState.eei.getGasLeft(), runState, common);
            let data = Buffer.alloc(0);
            if (!length.isZero()) {
                data = runState.memory.read(offset.toNumber(), length.toNumber());
            }
    ...
    [
        ...
        async function (runState, common) {
            ...
            runState.eei.useGas(new ethereumjs_util_1.BN(common.param('gasPrices', 'sha3Word')).imul(util_1.divCeil(length, new ethereumjs_util_1.BN(32))), 'CREATE2 opcode');
            let gasLimit = new ethereumjs_util_1.BN(runState.eei.getGasLeft());
            gasLimit = util_1.maxCallGas(gasLimit, runState.eei.getGasLeft(), runState, common); // CREATE2 is only available after TangerineWhistle (Constantinople introduced this opcode)
            let data = Buffer.alloc(0);
            if (!length.isZero()) {
                data = runState.memory.read(offset.toNumber(), length.toNumber());
            }
    ...
    [
        ...
        async function (runState, common) {
            ...
            util_1.subMemUsage(runState, inOffset, inLength, common);
            util_1.subMemUsage(runState, outOffset, outLength, common);
            EIP2929_1.accessAddressEIP2929(runState, toAddress, common);
            if (!value.isZero()) {
            ...
            const gasLimit = util_1.maxCallGas(currentGasLimit, runState.eei.getGasLeft(), runState, common);
    ...
    [
        ...
        async function (runState, common) {
            ...
            util_1.subMemUsage(runState, outOffset, outLength, common);
            EIP2929_1.accessAddressEIP2929(runState, toAddress, common);
            const gasLimit = util_1.maxCallGas(currentGasLimit, runState.eei.getGasLeft(), runState, common); // we set TangerineWhistle or later to true here, as STATICCALL was available from Byzantium (which is after TangerineWhistle)
            let data = Buffer.alloc(0);
            if (!inLength.isZero()) {
                data = runState.memory.read(inOffset.toNumber(), inLength.toNumber());
            }
    ...
    [
        ...
        async function (runState, common) {
            ...
            EIP2929_1.accessAddressEIP2929(runState, selfdestructToAddress, common, true, true);
