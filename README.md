...
1. `git clone https://github.com/NFTX-project/floor-contracts.git `
...
1. Add .env file
1. Rinkeby deployment: `npx hardhat run scripts/deployNewContracts.js --network rinkeby`
