...
contract wGOAT is ERC20 {
    ...
    /**
        ...
        @return uint
     */
    function unwrapToGOAT( uint _amount ) external returns ( uint ) {
    ...
    /**
        ...
        @return uint
     */
    function unwrapTosGOAT( uint _amount ) external returns ( uint ) {
        _burn( msg.sender, _amount );
    ...
    /**
        ...
        @return uint
     */
    function sGOATValue( uint _amount ) public view returns ( uint ) {
    ...
    /**
        ...
        @return uint
     */
    function wGOATValue( uint _amount ) public view returns ( uint ) {
