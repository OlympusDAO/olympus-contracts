...
contract TreasuryMock is FloorAccessControlled, ITreasury {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(
        ...
        // OVERRIDE: Set a high level of reserves by default
        totalReserves = 1000000000000;
    }
    ...
    function excessReserves() public view override returns (uint256) {
    	// OVERRIDE: Returns a constant value
