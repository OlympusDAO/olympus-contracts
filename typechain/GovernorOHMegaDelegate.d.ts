...
interface GovernorOHMegaDelegateInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorOHMegaDelegate extends BaseContract {
  ...
  interface: GovernorOHMegaDelegateInterface;
