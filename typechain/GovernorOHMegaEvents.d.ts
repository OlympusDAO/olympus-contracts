...
interface GovernorOHMegaEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class GovernorOHMegaEvents extends BaseContract {
  ...
  interface: GovernorOHMegaEventsInterface;
