...
interface GovernorOHMegaDelegatorInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorOHMegaDelegator extends BaseContract {
  ...
  interface: GovernorOHMegaDelegatorInterface;
