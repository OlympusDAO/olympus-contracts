...
async function main() {
    ...
    console.log("1");
    const treasuryV2 = await ethers.getContractAt(
        "TestnetTreasury",
        "0x0C6E0643Ed22E046dd1A2fB3250bbE5261D0DDD7"
    );
    console.log("2");
    const migrator = await ethers.getContractAt(
        "OlympusTokenMigrator",
        "0xb82E0EA1b7E5cdF636aa4ee5F09b1b0D4dBDBa14"
    );
    console.log("3");
    const authority = await ethers.getContractAt(
        "OlympusAuthority",
        "0x571CB39Ce761A60992494Ed5a90db545Cb5739aB"
    );
    console.log("4");
    const dai = await ethers.getContractAt("DAI", "0x26Ea52226a108ba48b9343017A5D0dB1456D4474");
    console.log("5");
    const sohmV2 = await ethers.getContractAt(
        "TestnetSohm",
        "0x32AAB42931B170629E81996453F38e7e717CF475"
    );
    console.log("6");
    const stakingV2 = await ethers.getContractAt(
        "TestnetStaking",
        "0x7Ce6F1C558dBA1Eacc7a8805bc73Bf178C613d1E"
    );
    console.log("7");
    ...
    console.log("8");
    const ohmV2 = await ethers.getContractAt(
        "TestnetOhm",
        "0x6a3ac556233eF72e62Fa977d951F1D0ADF69d0D0"
    );
    console.log("9");
    const gohm = await ethers.getContractAt(
        "TestnetGohm",
        "0xfD09738Db60f2d62A1C7E3754112C48F36eb788a"
    );
    console.log("10");
    ...
    console.log("11");
    const distributorV2 = await ethers.getContractAt(
        "TestnetDistributor",
        "0x8EE1C4F6e8A3aB60A011100192B3265c47C6b01b"
    );
    console.log("12");
    const faucet = await ethers.getContractAt(
        "DevFaucet",
        "0x73d65545441a3d086314083085824a4ef8AD215a"
    );
    ...
    const depositDai = await treasuryV2.deposit(
