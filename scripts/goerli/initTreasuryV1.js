...
async function main() {
  ...
  const sohmV1 = await ethers.getContractAt("TestnetSohmV1", "0x6BfbD5A8B09dd27fDDE73B014c664A5330C23Bfa");
  const stakingV1 = await ethers.getContractAt("TestnetStakingV1", "0x1c18053B3FD90FC5C4Af7267D3B4D49Aa63396C1");
  const stakingWarmupV1 = await ethers.getContractAt("TestnetStakingWarmupV1", "0x88E0d373E09AD5E34f5F349647D20022914EcE9B");
  const stakingHelperV1 = await ethers.getContractAt("TestnetStakingHelperV1", "0x21607BE08d64E5f6424982C656E5B88d5F6b83d8");
  const dai = await ethers.getContractAt("DAI", "0x26Ea52226a108ba48b9343017A5D0dB1456D4474");
  const distributorV1 = await ethers.getContractAt("TestnetDistributorV1", "0xB79b2F164c966ee1D0bd6eF3D4cc9e86567C8E07");
  ...
  */
  ...
  await (await treasuryV1.deposit("9000000000000000000000000", dai.address, "8400000000000000")).wait();
